...
<script>
	$(document).ready(function()
	{
		...
		$('.addcart').click(function()
		{
			...
			$.get('http://localhost/wlarapro12/addcart',{bookid:bid,bookname:bname,bookprice:bprice,bookimage:bimage,bookquan:bquan},function(res)
			{
				alert(res);
				//location.reload();
				getinfo();
		...
		function getinfo()
		{
			$.ajax({
				method : 'get',
				url : 'http://localhost/wlarapro12/getinfo',
				success : function(res)
				{
					//alert(res);
					$('#getinfoarea').html(res);
				},
				error : function()
				{
					alert('Not Working');
...
<!-- header -->
	<header>
		<div class="w3layouts-top-strip">
			<div class="container">
				<div class="logo">
					<h1><a href="index.html">Digital News</a></h1>
			  ...
			  <div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
					...
					<a href="{{url('/cartdetails')}}" id="getinfoarea"></a>
